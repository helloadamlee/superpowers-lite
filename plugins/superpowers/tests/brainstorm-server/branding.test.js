/**
 * Tests for the visual companion's local Superpowers branding.
 */
...
async function main() {
  ...
  await test('framed screens render local branding without a remote logo', async () => {
    const port = 3451;
  ...
  await test('waiting screen renders local branding without a remote logo', async () => {
    const port = 3452;
